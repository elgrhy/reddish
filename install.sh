...
PLUGINS=("audit.plugin.yaml" "core.plugin.yaml" "evolution.plugin.yaml" "security.plugin.yaml" "swarm.plugin.yaml" "telegram.plugin.yaml" "whatsapp.plugin.yaml" "social.plugin.yaml" "deploy.plugin.yaml" "instagram.plugin.yaml" "tiktok.plugin.yaml" "youtube.plugin.yaml" "web.plugin.yaml")
